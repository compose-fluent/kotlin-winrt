...
class KotlinProjectionGeneratorTest {
    ...
    @Test
    fun generator_rejects_authoring_activation_factory_plan_with_factory_interface_without_iid() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            error!!.message.orEmpty(),
            error.message.orEmpty().contains(
                "Generator requires authored runtime class Sample.Foundation.Widget activation factory interface Sample.Foundation.IWidgetFactory to carry metadata IID before authoring support rendering.",
            ),
        )
    }
    ...
    @Test
    fun support_renderer_rejects_authored_ccw_method_without_slot_metadata_before_support_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            message,
            message.contains(
                "Support renderer requires authored CCW binding Sample.Foundation.IWidget.REFRESH_SLOT to carry ABI slot metadata before rendering authoring CCW definitions.",
            ),
        )
    }
    ...
    @Test
    fun generator_routes_instance_boolean_methods_with_struct_arguments_through_projection_intrinsic() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(geometryContents.contains("fun checkPoint(point: Point): Boolean"))
        assertTrue(geometryContents.contains("WinRtProjectionIntrinsic.callBoolean("))
        assertTrue(geometryContents.contains("\"Struct8_4\""))
        assertTrue(geometryContents.contains("point,"))
        assertTrue(geometryContents.contains("Point.Metadata,"))
        assertFalse(geometryContents.contains("PlatformAbi.allocateBytes"))
    ...
    fun generator_rejects_delegate_without_iid_before_projection_rendering() {
        ...
        assertTrue(
            message,
            message.contains("requires delegate Sample.Foundation.WidgetHandler Invoke to carry metadata IID before projection rendering"),
        )
    }

    @Test
    fun generator_rejects_delegate_invoke_unsupported_return_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        WinRtTypeDefinition(
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    name = "Invoke",
                                    returnTypeName = "Sample.Foundation.NativeHandle",
                                ),
                            ),
                        ),
                    ),
        ...
        assertTrue(
            message,
            message.contains("requires delegate Sample.Foundation.WidgetHandler ABI binding Invoke return to use supported ABI metadata before projection rendering; found Unsupported(Sample.Foundation.NativeHandle)"),
        )
    }

    @Test
    fun generator_rejects_delegate_invoke_unsupported_array_parameter_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                        ...
                        WinRtTypeDefinition(
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    ...
                                    returnTypeName = "Unit",
                                    parameters = listOf(
                                        WinRtParameterDefinition("values", "Array<Int>"),
                                    ),
                                ),
                            ),
                        ),
        ...
        assertTrue(
            message,
            message.contains("requires delegate Sample.Foundation.WidgetHandler ABI binding Invoke parameter values delegate array Array to use supported delegate array ABI metadata before projection rendering; found Array(Int32)"),
        )
    }
    ...
    @Test
    fun generator_rejects_mapped_vector_owner_unsupported_element_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        WinRtTypeDefinition(
                            ...
                            iid = Guid("11111111-2222-3333-4444-555555555557"),
                            implementedInterfaces = listOf(
                                WinRtInterfaceImplementationDefinition("Windows.Foundation.Collections.IVector<Sample.Foundation.NativeHandle>"),
                            ),
                        ),
                    ),
                ),
        ...
        assertTrue(
            message,
            message.contains(
                "Generator mutable collection parity does not yet support IVector owner element Unsupported(Sample.Foundation.NativeHandle) on Sample.Foundation.IHandles.",
            ),
        )
    }

    @Test
    fun generator_rejects_mapped_map_owner_unsupported_key_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        WinRtTypeDefinition(
                            ...
                            iid = Guid("11111111-2222-3333-4444-555555555558"),
                            implementedInterfaces = listOf(
                                WinRtInterfaceImplementationDefinition("Windows.Foundation.Collections.IMap<Sample.Foundation.NativeHandle, Int>"),
                            ),
                        ),
                    ),
                ),
        ...
        assertTrue(
            message,
            message.contains(
                "Generator mutable collection parity does not yet support IMap owner key Unsupported(Sample.Foundation.NativeHandle) on Sample.Foundation.IHandleMap.",
            ),
        )
    }
    ...
    @Test
    fun generator_rejects_reference_return_without_renderable_element_signature_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        ...
                        WinRtTypeDefinition(
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    name = "getValue",
                                    returnTypeName = "Windows.Foundation.IReference<Sample.Foundation.WidgetHandler>",
                                    methodRowId = 6,
                                ),
                            ),
                        ),
        ...
        assertTrue(
            message,
            message.contains(
                "Generator requires interface Sample.Foundation.IWidget ABI binding GETVALUE_SLOT return reference Windows.Foundation.IReference element Sample.Foundation.WidgetHandler to have a renderable WinRT type signature before projection rendering.",
            ),
        )
    }
    ...
    fun generator_projects_required_iterator_helper_surface() {
        ...
        assertTrue(contents, contents.contains("Metadata.acquireInterface("))
        assertTrue(contents, contents.contains("ParameterizedInterfaceId.createFromSignature("))
        assertTrue(contents, contents.contains("WinRtCollectionInterfaceIds.iteratorSignature(WinRtTypeSignature.string())"))
        assertFalse(contents, contents.contains("Metadata.acquireInterface(_inner, IIterator.Metadata.IID)"))
    ...
    @Test
    fun generator_rejects_static_runtime_surface_without_static_interface_iid() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            error!!.message.orEmpty()
                .contains("requires runtime class Sample.Foundation.Widget static interface Sample.Foundation.IWidgetStatics to carry metadata IID before projection rendering"),
        )
    }
    ...
    @Test
    fun generator_rejects_runtime_surface_without_implemented_interface_definition() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        ...
                        WinRtTypeDefinition(
                            ...
                            implementedInterfaces = listOf(
                                WinRtInterfaceImplementationDefinition("Sample.Foundation.IWidget", isDefault = true),
                                WinRtInterfaceImplementationDefinition("Sample.Foundation.IWidgetExtra"),
                            ),
                        ),
                    ),
                ),
        ...
        assertTrue(
            error!!.message.orEmpty()
                .contains("requires runtime class Sample.Foundation.Widget implemented interface Sample.Foundation.IWidgetExtra to be present in the metadata model"),
        )
    }
    ...
    fun generator_rejects_runtime_surface_without_implemented_interface_iid() {
        ...
        assertTrue(
            error!!.message.orEmpty()
                .contains("requires runtime class Sample.Foundation.Widget implemented interface Sample.Foundation.IWidgetExtra to carry metadata IID before projection rendering"),
        )
    }

    @Test
    fun generator_rejects_runtime_surface_without_required_interface_definition() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        WinRtTypeDefinition(
                            ...
                            iid = Guid("11111111-2222-3333-4444-555555555555"),
                            implementedInterfaces = listOf(
                                WinRtInterfaceImplementationDefinition("Sample.Foundation.IWidgetRequired"),
                            ),
                        ),
                        WinRtTypeDefinition(
                            namespace = "Sample.Foundation",
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget required interface Sample.Foundation.IWidgetRequired to be present in the metadata model"),
        )
    }

    @Test
    fun generator_rejects_runtime_surface_without_required_interface_iid() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget required interface Sample.Foundation.IWidgetRequired to carry metadata IID before projection rendering"),
        )
    }
    ...
    @Test
    fun generator_rejects_mapped_property_changed_event_handler_with_generic_argument_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        WinRtTypeDefinition(
                            ...
                            events = listOf(
                                WinRtEventDefinition(
                                    name = "PropertyChanged",
                                    delegateTypeName = "Microsoft.UI.Xaml.Data.PropertyChangedEventHandler<String>",
        ...
        assertTrue(
            message,
            message.contains(
                "Generator requires interface Sample.Foundation.IWidget event PropertyChanged mapped delegate Microsoft.UI.Xaml.Data.PropertyChangedEventHandler<String> to carry 0 generic argument(s) before projection rendering; found 1.",
            ),
        )
    }
    ...
    @Test
    fun generator_rejects_static_event_without_accessor_binding() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            message,
            message
                .contains("requires runtime class Sample.Foundation.Widget static event Updated add binding STATIC_UPDATED_ADD_SLOT to be present before projection rendering"),
        )
    }
    ...
    @Test
    fun generator_rejects_abi_member_delegate_invoke_unsupported_return_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget ABI binding SETHANDLER_SLOT parameter handler delegate Sample.Foundation.WidgetHandler Invoke return to use supported ABI metadata before projection rendering; found Unsupported(Sample.Foundation.NativeHandle)"),
        )
    }
    ...
    @Test
    fun generator_rejects_abi_member_projected_interface_parameter_without_interface_iid() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                        ...
                        WinRtTypeDefinition(
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    name = "setWidget",
                                    returnTypeName = "Unit",
                                    parameters = listOf(WinRtParameterDefinition("widget", "Sample.Foundation.IWidget")),
                                    methodRowId = 6,
                                ),
                            ),
                        ),
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidgetSink ABI binding SETWIDGET_SLOT parameter widget interface Sample.Foundation.IWidget to carry metadata IID before projection rendering"),
        )
    }
    ...
    fun generator_rejects_abi_member_unsupported_parameter_before_projection_rendering() {
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget ABI binding SETHANDLE_SLOT parameter handle to use supported ABI metadata before projection rendering; found Unsupported(Sample.Foundation.NativeHandle)"),
        )
    }
    ...
    fun generator_rejects_abi_member_unsupported_return_before_projection_rendering() {
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget ABI binding GETHANDLE_SLOT return to use supported ABI metadata before projection rendering; found Unsupported(Sample.Foundation.NativeHandle)"),
        )
    }

    @Test
    fun generator_rejects_abi_member_nested_unsupported_generic_argument_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    ...
                                    parameters = listOf(
                                        WinRtParameterDefinition(
                                            "handles",
                                            "Windows.Foundation.Collections.IVector<Sample.Foundation.NativeHandle>",
                                        ),
                                    ),
                                    methodRowId = 6,
                                ),
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget ABI binding SETHANDLES_SLOT parameter handles to use supported ABI metadata before projection rendering; found Unsupported(Sample.Foundation.NativeHandle)"),
        )
    }

    @Test
    fun generator_rejects_abi_member_array_unsupported_element_before_projection_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    ...
                                    parameters = listOf(
                                        WinRtParameterDefinition(
                                            "values",
                                            "Array<Sample.Foundation.NativeHandle>",
                                            isInParameter = true,
                                        ),
                                    ),
                                    methodRowId = 6,
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget ABI binding SETVALUES_SLOT parameter values to use supported ABI metadata before projection rendering; found Unsupported(Sample.Foundation.NativeHandle)"),
        )
    }

    @Test
    fun generator_rejects_abi_member_enum_parameter_without_underlying_type() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        WinRtTypeDefinition(
                            ...
                            name = "WidgetKind",
                            kind = WinRtTypeKind.Enum,
                            enumMembers = listOf(WinRtEnumMemberDefinition("small", 0u)),
                        ),
                        WinRtTypeDefinition(
                            namespace = "Sample.Foundation",
                            name = "IWidget",
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    name = "setKind",
                                    returnTypeName = "Unit",
                                    parameters = listOf(WinRtParameterDefinition("kind", "Sample.Foundation.WidgetKind")),
                                    methodRowId = 6,
                                ),
                            ),
                        ),
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget ABI binding SETKIND_SLOT parameter kind enum Sample.Foundation.WidgetKind to carry underlying type metadata before projection rendering"),
        )
    }

    @Test
    fun generator_rejects_abi_member_enum_return_without_underlying_type() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                    types = listOf(
                        ...
                        WinRtTypeDefinition(
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    name = "getKind",
                                    returnTypeName = "Sample.Foundation.WidgetKind",
                                    methodRowId = 6,
                                ),
                            ),
                        ),
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget ABI binding GETKIND_SLOT return enum Sample.Foundation.WidgetKind to carry underlying type metadata before projection rendering"),
        )
    }

    @Test
    fun generator_rejects_abi_member_nested_enum_generic_argument_without_underlying_type() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    ...
                                    parameters = listOf(
                                        WinRtParameterDefinition(
                                            "kinds",
                                            "Windows.Foundation.Collections.IVector<Sample.Foundation.WidgetKind>",
                                        ),
                                    ),
                                    methodRowId = 6,
                                ),
        ...
        assertTrue(
            message,
            message
                .contains("requires interface Sample.Foundation.IWidget ABI binding SETKINDS_SLOT parameter kinds enum Sample.Foundation.WidgetKind to carry underlying type metadata before projection rendering"),
        )
    }
    ...
    @Test
    fun generator_rejects_instance_method_without_method_binding() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            message,
            message
                .contains("requires runtime class Sample.Foundation.Widget method Refresh binding REFRESH_SLOT to be present before projection rendering"),
        )
    }
    ...
    fun generator_rejects_static_property_setter_without_static_setter_binding() {
        ...
        assertTrue(
            message,
            message
                .contains("requires runtime class Sample.Foundation.Widget static property Count setter binding STATIC_COUNT_SETTER_SLOT to be present before projection rendering"),
        )
    }

    @Test
    fun generator_rejects_static_property_getter_without_static_getter_binding() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            message,
            message
                .contains("requires runtime class Sample.Foundation.Widget static property Count getter binding STATIC_COUNT_GETTER_SLOT to be present before projection rendering"),
        )
    }

    @Test
    fun generator_rejects_static_property_setter_only_without_static_setter_binding() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
    ...
    @Test
    fun generator_rejects_static_method_without_static_method_binding() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
        ...
        assertTrue(
            message,
            message
                .contains("requires runtime class Sample.Foundation.Widget static method GetCount binding STATIC_GETCOUNT_SLOT to be present before projection rendering"),
        )
    }
    ...
    fun generator_rejects_composable_factory_create_without_trailing_object_parameters_before_projection_rendering() {
                        ...
                        WinRtTypeDefinition(
                            ...
                            methods = listOf(
                                WinRtMethodDefinition(
                                    ...
                                    parameters = listOf(
                                        WinRtParameterDefinition("baseInterface", "Object"),
                                        WinRtParameterDefinition("innerInterface", "Int"),
                                    ),
                                ),
                            ),
                        ),
        ...
        assertTrue(
            message,
            message.contains(
                "Generator requires runtime class Sample.Foundation.Widget composable factory interface Sample.Foundation.IWidgetFactory method CreateInstance to end with baseInterface and innerInterface object parameters before projection rendering.",
            ),
        )
    }
    ...
    @Test
    fun generator_rejects_authored_ccw_method_without_slot_metadata_before_support_rendering() {
        val model = WinRtMetadataModel(
            namespaces = listOf(
                WinRtNamespace(
                    name = "Sample.Foundation",
