...
- [x] Closed KWINRT-031 projection-unsafe authoring TypeDetails casts: generated authoring bridges now route WinRT runtime-class dispatch through `winrtAs(Metadata.TYPE_HANDLE)` instead of direct Kotlin runtime-class casts, while authored-class dispatch keeps the narrow local cast path.
