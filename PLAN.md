...
- [ ] Authoring writer output 正在做: generated support now covers metadata mapping, wrapper shells, ABI class facades, custom QI, server factories, module activation registration, and CCW method tables for the current scalar/String/Guid/struct/object-reference/delegate set; next is array/generic member marshaling coverage.
