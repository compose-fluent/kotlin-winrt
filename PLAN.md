...
- [ ] Manifest closure 正在做: validate packaged-mode `Applications/Application` presence, application id, executable/entry-point consistency, identity, visual elements, manifest payload references, and fail-closed diagnostics before package creation and verification.
