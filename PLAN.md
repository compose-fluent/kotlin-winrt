...
- [ ] Authoring writer output 正在做: generated support now covers metadata mapping, wrapper shells, ABI class facades, ABI runtime-class array facades, custom QI, server factories, module activation registration, and CCW method tables for scalar/String/Guid/struct/System.Object/object-reference/delegate/generic-parameter plus PassArray/FillArray/array-return handoff; next is generic array and broader host packaging coverage.
