...
- [ ] Expect/actual generator slice 正在做: run targeted `:winrt-generator:test` coverage for ordinary common interfaces, JVM projection support objects, runtime-class actual forwards, projected-interface ABI calls, fallback gates, and scalar FFM descriptors.
