...
- [x] Generator fail-closed baseline: missing or incomplete ABI metadata is rejected before rendering for the already-covered activation/static/factory, default/implemented/required interface, delegate/event, enum/struct/array, property, method, factory-create, authored CCW member, and ABI call-plan slices.
