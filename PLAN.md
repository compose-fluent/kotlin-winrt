...
- [ ] `winrt-generator` remains in `.cswinrt/src/cswinrt` parity follow-through: the latest audit leaves only server activation/module factory/user-subclassing rules authoring-gated until `winrt-authoring` is unfrozen.
