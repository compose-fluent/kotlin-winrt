...
- [ ] Authoring writer output 正在做: generated support now covers metadata mapping, wrapper shells, ABI class facades, custom QI, server factories, module activation registration, and CCW method tables for the current scalar/String/Guid/EventRegistrationToken/object-reference set; next is widening member marshaling coverage.
