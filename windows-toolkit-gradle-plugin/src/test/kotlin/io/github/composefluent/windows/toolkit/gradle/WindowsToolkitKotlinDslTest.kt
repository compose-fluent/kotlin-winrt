            ...
            tasks.register("verifyWinRTKotlinDslAssignments") {
                doLast {
                    val configured = project.extensions.getByType(
                        io.github.composefluent.windows.toolkit.gradle.WindowsExtension::class.java,
                    )
                    ...
                    check(configured.application.packageType.get() == io.github.composefluent.windows.toolkit.gradle.WindowsPackageType.None)
