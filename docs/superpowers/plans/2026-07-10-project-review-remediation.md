...
- [ ] **Step 1: Add GUID layout regressions**
...
- [ ] **Step 2: Verify the GUID test fails**
...
- [ ] **Step 3: Correct both shared GUID descriptors**

Set both GUID alignment constants to `4`; do not add a third GUID classification table.

- [ ] **Step 4: Add object-array shape regressions**
...
- [ ] **Step 5: Verify the object-array test fails**
...
- [ ] **Step 8: Verify weak-reference cleanup fails**
...
- [ ] **Step 9: Register idempotent finalization cleanup**
...
- [ ] **Step 10: Validate and commit runtime slice**
...
- [ ] **Step 1: Add conflicting IID merge test**
...
- [ ] **Step 2: Verify the conflict test fails**
...
- [ ] **Step 3: Add explicit IID merge validation**
...
- [ ] **Step 4: Validate and commit metadata slice**
...
- [ ] **Step 1: Add authored array allocator rendering test**
...
- [ ] **Step 2: Verify allocator rendering test fails**
...
- [ ] **Step 3: Emit CoTaskMem ownership transfer**
...
- [ ] **Step 4: Add duplicate output-path test**
...
- [ ] **Step 5: Verify collision test fails**
...
- [ ] **Step 6: Reject duplicate normalized paths**
...
- [ ] **Step 7: Add activation factory output test**
...
- [ ] **Step 8: Verify activation factory test fails**
...
- [ ] **Step 9: Clear output before fallible operations**
...
- [ ] **Step 10: Validate and commit generator/authoring slice**
...
- [ ] **Step 1: Add cross-artifact duplicate audit regression**
...
- [ ] **Step 2: Verify duplicate audit regression fails**
...
- [ ] **Step 3: Add cross-owner inputs and wire split artifacts**
...
- [ ] **Step 6: Remove dependency-owned generated output**
...
- [ ] **Step 7: Validate and commit projection slice**
...
- [ ] **Step 1: Add authoring-only TestKit regression**
...
- [ ] **Step 2: Verify authoring-only fixture fails**
...
- [ ] **Step 3: Split decision providers**
...
- [ ] **Step 4: Preserve runtime-only and forwarding-library behavior**
...
- [ ] **Step 5: Validate and commit Gradle slice**
...
- [ ] **Step 1: Add sample-mode configuration regression**
...
- [ ] **Step 2: Verify disabled mode is currently unreachable**
...
- [ ] **Step 3: Add explicit sample enable property**
...
- [ ] **Step 4: Add final review remediation gate**
...
- [ ] **Step 6: Commit final validation slice**
