...
5. The root `PLAN.md` is the repository's canonical planning file and remains subject to the Planning File Rules below; required updates to it are not considered prohibited Superpowers-generated documentation.
